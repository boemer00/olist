...
class Order:
    ...
    def get_wait_time(self, is_delivered=True):
        ...
        """
        # this method gives access to the instance of the class Order in the variable self
        ...
        def handle_delay(x):
            # keep delay where wait_time is longer than expected (it drives customer dissatisfaction)
            if x < 0:
                return abs(x)
            return 0
    ...
    def get_number_products(self):
        ...
        data = self.data
        products = data['order_items'].groupby('order_id', as_index=False).agg({'order_item_id': 'count'})
    ...
    def get_distance_seller_customer(self):
        """
        Returns a DataFrame with:
        order_id and distance between seller and customer
        """
        # import data
        data = self.data
        ...
        order_distance = matching_geo.groupby('order_id',
